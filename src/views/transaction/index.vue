    ...
    <div v-else>
      ...
      <div class="block-content">
        ...
        <div class="block-content-single-item">
          ...
          <span
            class="block-content-text trans-content-text"
            v-if="transactionHistory.fees"
          >
            <span class="trans-content-text-first">
              <strong>{{
        ...
        <div class="block-content-single-item">
          ...
          <span
            class="block-content-text  trans-content-text"
            v-if="transactionHistory.commission"
          >
            <span class="trans-content-text-first">
              <strong>{{
        ...
        <div class="block-content-single-item" v-if="isPack">
          ...
          <span
            class="block-content-text  trans-content-text"
            v-if="transactionHistory.pack_fees"
          >
            <span class="trans-content-text-first">
              <strong>{{
